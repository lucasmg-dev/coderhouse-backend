...
console.log("length", JSON.stringify(empresa).length);

const person = new schema.Entity("personas");

const business = new schema.Entity("empresas", {
  gerente: person,
  encargado: person,
  empleados: [person],
});

const normalizedData = normalize(empresa, business);
